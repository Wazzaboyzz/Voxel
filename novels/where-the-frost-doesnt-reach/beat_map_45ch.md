# WHERE THE FROST DOESN'T REACH — 45-CHAPTER BEAT MAP

Checkpoint math (must hold after expansion):
- First kiss: ch16/24 = 66.7% → ch30/45 = 66.7% ✓ exact match
- Rupture: ch18/24 = 75.0% → ch34/45 = 75.6% ✓ close match
...
This requires substantial NEW scene material, not just deepening existing scenes —
flagged per chapter below as EXISTING (expand from source) or NEW (write from scratch,
consistent with architecture.md and established voice/continuity).

| New Ch | Source (old ch) | Content | Type | Written by |
|---|---|---|---|---|
| 1 | 1 | Funeral reunion | EXISTING | ch1-15 orig: prior/uploaded session (non-Claude). Ch16-24 orig: this conversation. Expanded versions below: see notes. |
| 2 | 2 | Ring found | EXISTING | Expanded once already this conversation; ALSO expanded in Ch_1_to_10_expanded.zip by a different profile — versions conflict, pick one before proceeding |
| 3 | 3 | Fence-line truth | EXISTING | Same conflict as ch1-2 above |
| 4 | NEW | Mara settles in, first real Odette/orchard interaction, seeds unease | NEW | Not yet written |
| 5 | NEW | Mara's first proper visit to Thomas at care home, glimpses his fear | NEW | Not yet written |
| 6 | 4 (part 1) | Thomas's first partial reveal — tolling exists | EXISTING | Ch_1_to_10_expanded.zip profile (need to verify — check zip against this split) |
| 7 | 4 (part 2) | Thomas continues explaining; Caleb's reaction | EXISTING | Ch_1_to_10_expanded.zip profile (verify) |
| 8 | 5 (part 1) | Finding the 1986 case file | EXISTING | Ch_1_to_10_expanded.zip profile (verify) |
| 9 | 5 (part 2) | Kell's name circled — first real suspicion | EXISTING | Ch_1_to_10_expanded.zip profile (verify) |
| 10 | 6 (part 1) | Odette's confession begins | EXISTING | Ch_1_to_10_expanded.zip profile (verify) |
| 11 | 6 (part 2) | Odette reveals Kell's question about Mara; porch hand-touch | EXISTING | Ch_1_to_10_expanded.zip profile (verify — this may be ch10 or 11 in that zip, confirm mapping) |
| 12 | NEW | Quiet orchard day — Toll properly introduced, found-family beat | NEW | Not yet written |
| 13 | 7 (part 1) | Wren introduced — barn door touch, fragmented flash | EXISTING | Not yet written (past ch10, no expanded version exists yet) |
| 14 | 7 (part 2) | Dev goes missing — Priya's fear | EXISTING | Not yet written |
| 15 | NEW | Priya/Dev sibling backstory scene, deepens their relationship | NEW | Not yet written |
| 16 | 8 | Dev found in silo, initial confession | EXISTING | Not yet written |
...
| 38 | 20 | Hospital break-in, Corinne named, hallway reconciliation | EXISTING | Not yet written |
| 39 | 21 | Wren kidnapped, Kell's full confession re: Adelaide | EXISTING | Not yet written |
| 40 | NEW | Travel-to-the-mill tension scene, stakes laid out fully | NEW | Not yet written |
...
- Must read architecture.md + all adjacent EXISTING chapters (before and after) before writing, not just this beat-map row.
